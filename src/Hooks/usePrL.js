...
function usePr (type) {
    ...
    function setPrConditional (data, totalP = 0) {
    ...
    function selectBrand (id, name, total = 1) {

          for (let i = 0; i <= total; i++) {
            if (i !== id) {
              document.getElementById("brand" + i).style.border = '1px solid rgba(0, 0, 0, 0.065)';
            } else {
              document.getElementById("brand" + i).style.border = '1px solid #00ccff';
            }
          }
    }
